...
async function getMintAuthority(tokenMintAddress) {
  console.log('Mint Authority:', tokenMintAddress);
  const mintPublicKey = new PublicKey(tokenMintAddress);
  const mintInfo = await getMint(solanaConnection, mintPublicKey);

  console.log('Mint Authority:', mintInfo);
}
